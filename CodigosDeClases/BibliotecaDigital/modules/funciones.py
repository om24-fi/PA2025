...
def cargar_lista_desde_archivo(nombre_archivo, lista_libros): #PARA QUE PONEMOS ESTO? PORQUE NO LO HACEMOS DIRECTO
...
def guardar_libro_en_archivo(nombre_archivo, nombre, autor, calificacion): 
    """Guarda la información ingresada de un libro en archivo
    """   
